...
*/
 ...
 planeX=planeX+1;//Makes plane move to the right over time
  ...
  stroke(0);
  line(200, 190, 200, 290);//Draw first segment of string
  rotate(PI/2);
  line(290,-200,380,-250);; //Draw first slanted segment of string
  line(380,-250, 430, -200);//Draw second segment of string
  line(430, -200, 480, -250);//Draw final segment of string
 } 